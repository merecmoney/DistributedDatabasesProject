...
--@Descripción: Creación de sinónimos en PDB cahabdd_s2

-- SUCURSAL
create or replace synonym SUCURSAL_F1 for SUCURSAL_F1_CAH_S1@cahabdd_s1;
create or replace synonym SUCURSAL_F2 for SUCURSAL_F2_CAH_S2;
...
create or replace synonym LAPTOP_INVENTARIO_F2 for LAPTOP_INVENTARIO_F2_CAH_S1@cahabdd_s1;

-- HISTORICO_STATUS_LAPTOP
create or replace synonym HISTORICO_STATUS_LAPTOP_F1 for HISTORICO_STATUS_LAPTOP_F1_S2;
create or replace synonym HISTORICO_STATUS_LAPTOP_F2 for HISTORICO_STATUS_LAPTOP_F2_S1@cahabdd_s1;

-- SERVICIO_LAPTOP
create or replace synonym SERVICIO_LAPTOP_F1 for SERVICIO_LAPTOP_F1_CAH_S1@cahabdd_s1;
...
create or replace synonym SERVICIO_LAPTOP_F4 for SERVICIO_LAPTOP_F4_CAH_S2;

-- LAPTOP
create or replace synonym LAPTOP_F1 for LAPTOP_F1_MMG_S2@mamgbd_s2;
create or replace synonym LAPTOP_F2 for LAPTOP_F2_CAH_S1@cahabdd_s1;
...
create or replace synonym LAPTOP_F5 for LAPTOP_F5_CAH_S2;

-- SUCURSAL_TALLER
create or replace synonym SUCURSAL_TALLER_F1 for SUCURSAL_TALLER_F1_CAH_S1@cahabdd_s1;
create or replace synonym SUCURSAL_TALLER_F2 for SUCURSAL_TALLER_F2_CAH_2;
...
-- SUCURSAL_VENTA
create or replace synonym SUCURSAL_VENTA_F1 for SUCURSAL_VENTA_F1_CAH_S1@cahabdd_s1;
create or replace synonym SUCURSAL_VENTA_F2 for SUCURSAL_VENTA_F2_CAH_S2;
...
-- TIPO_ALMACENAMIENTO
create or replace synonym TIPO_ALMACENAMIENTO_R_1 for TIPO_ALMACENAMIENTO_R_CAH_S2;
create or replace synonym TIPO_ALMACENAMIENTO_R_2 for TIPO_ALMACENAMIENTO_R_CAH_S1@cahabdd_s1;
create or replace synonym TIPO_ALMACENAMIENTO_R_3 for TIPO_ALMACENAMIENTO_R_MMG_S1@mamgbd_s1;
create or replace synonym TIPO_ALMACENAMIENTO_R_4 for TIPO_ALMACENAMIENTO_R_MMG_S2@mamgbd_s2;

-- TIPO_MONITOR
create or replace synonym TIPO_MONITOR_R_1 for TIPO_MONITOR_R_CAH_S2;
create or replace synonym TIPO_MONITOR_R_2 for TIPO_MONITOR_R_CAH_S1@cahabdd_s1;
create or replace synonym TIPO_MONITOR_R_3 for TIPO_MONITOR_R_MMG_S1@mamgbd_s1;
create or replace synonym TIPO_MONITOR_R_4 for TIPO_MONITOR_R_MMG_S2@mamgbd_s2;

-- TIPO_PROCESADOR
create or replace synonym TIPO_PROCESADOR_R_1 for TIPO_PROCESADOR_R_CAH_S2;
create or replace synonym TIPO_PROCESADOR_R_2 for TIPO_PROCESADOR_R_CAH_S1@cahabdd_s1;
create or replace synonym TIPO_PROCESADOR_R_3 for TIPO_PROCESADOR_R_MMG_S1@mamgbd_s1;
create or replace synonym TIPO_PROCESADOR_R_4 for TIPO_PROCESADOR_R_MMG_S2@mamgbd_s2;

-- TIPO_TARJETA_VIDEO
create or replace synonym TIPO_TARJETA_VIDEO_R_1 for TIPO_TARJETA_VIDEO_R_CAH_S2;
create or replace synonym TIPO_TARJETA_VIDEO_R_2 for TIPO_TARJETA_VIDEO_R_CAH_S1@cahabdd_s1;
create or replace synonym TIPO_TARJETA_VIDEO_R_3 for TIPO_TARJETA_VIDEO_R_MMG_S1@mamgbd_s1;
