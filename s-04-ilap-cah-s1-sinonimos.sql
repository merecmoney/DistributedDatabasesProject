...
-- TIPO_ALMACENAMIENTO
create or replace synonym TIPO_ALMACENAMIENTO_R_1 for TIPO_ALMACENAMIENTO_R_CAH_S1;
create or replace synonym TIPO_ALMACENAMIENTO_R_2 for TIPO_ALMACENAMIENTO_R_CAH_S2@cahabdd_s2;
...
-- TIPO_MONITOR
create or replace synonym TIPO_MONITOR_R_1 for TIPO_MONITOR_R_CAH_S1;
create or replace synonym TIPO_MONITOR_R_2 for TIPO_MONITOR_R_CAH_S2@cahabdd_s2;
...
-- TIPO_PROCESADOR
create or replace synonym TIPO_PROCESADOR_R_1 for TIPO_PROCESADOR_R_CAH_S1;
create or replace synonym TIPO_PROCESADOR_R_2 for TIPO_PROCESADOR_R_CAH_S2@cahabdd_s2;
...
-- TIPO_TARJETA_VIDEO
create or replace synonym TIPO_TARJETA_VIDEO_R_1 for TIPO_TARJETA_VIDEO_R_CAH_S1;
create or replace synonym TIPO_TARJETA_VIDEO_R_2 for TIPO_TARJETA_VIDEO_R_CAH_S2@cahabdd_s2;
