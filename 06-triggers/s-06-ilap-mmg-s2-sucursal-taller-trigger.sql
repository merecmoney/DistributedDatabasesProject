...
--@Descripción: Definición del trigger para operaciones DML para SUCURSAL_TALLER en MAMGBD_S2


create or replace trigger t_dml_sucursal_taller_mmg_s2
