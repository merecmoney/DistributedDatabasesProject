...
--@Descripción: Definición del trigger para operaciones DML para LAPTOP en MAMGBD_S2

create or replace trigger t_dml_laptop_mmg_s2
...
begin
    case
      when inserting then
        ...
        -- Inserción local (MAMGBD_S2)
        if (v_num_serie = '2' or v_num_serie = '3') then
