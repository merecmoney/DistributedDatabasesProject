...
-- TIPO_ALMACENAMIENTO
create or replace synonym TIPO_ALMACENAMIENTO_R1 for TIPO_ALMACENAMIENTO_R_MMG_S2;
...
create or replace synonym TIPO_ALMACENAMIENTO_R4 for TIPO_ALMACENAMIENTO_R_MMG_S1@mamgbd_s1;

-- TIPO_MONITOR
create or replace synonym TIPO_MONITOR_R1 for TIPO_MONITOR_R_MMG_S2;
...
create or replace synonym TIPO_MONITOR_R4 for TIPO_MONITOR_R_MMG_S1@mamgbd_s1;

-- TIPO_PROCESADOR
create or replace synonym TIPO_PROCESADOR_R1 for TIPO_PROCESADOR_R_MMG_S2;
...
create or replace synonym TIPO_PROCESADOR_R4 for TIPO_PROCESADOR_R_MMG_S1@mamgbd_s1;

-- TIPO_TARJETA_VIDEO
create or replace synonym TIPO_TARJETA_VIDEO_R1 for TIPO_TARJETA_VIDEO_R_MMG_S2;
...
create or replace synonym TIPO_TARJETA_VIDEO_R4 for TIPO_TARJETA_VIDEO_R_MMG_S1@mamgbd_s1;
