...
--@Descripción: Creación de sinónimos en PDB mamgbd_s2
...
create or replace synonym SUCURSAL_F4 for SUCURSAL_F4_MMG_S2;
...
create or replace synonym SERVICIO_LAPTOP_F2 for SERVICIO_LAPTOP_F2_MMG_S2;
...
-- LAPTOP
create or replace synonym LAPTOP_F1 for LAPTOP_F1_MMG_S2;
create or replace synonym LAPTOP_F2 for LAPTOP_F2_CAH_S1@cahabdd_s1;
create or replace synonym LAPTOP_F3 for LAPTOP_F3_MMG_S2;
...
create or replace synonym SUCURSAL_TALLER_F4 for SUCURSAL_TALLER_F4_MMG_S2;
...
create or replace synonym SUCURSAL_VENTA_F4 for SUCURSAL_VENTA_F4_MMG_S2;

-- TIPO_ALMACENAMIENTO
create or replace synonym TIPO_ALMACENAMIENTO_R_1 for TIPO_ALMACENAMIENTO_R_MMG_S2;
...
create or replace synonym TIPO_ALMACENAMIENTO_R_4 for TIPO_ALMACENAMIENTO_R_MMG_S1@mamgbd_s1;

-- TIPO_MONITOR
create or replace synonym TIPO_MONITOR_R_1 for TIPO_MONITOR_R_MMG_S2;
...
create or replace synonym TIPO_MONITOR_R_4 for TIPO_MONITOR_R_MMG_S1@mamgbd_s1;

-- TIPO_PROCESADOR
create or replace synonym TIPO_PROCESADOR_R_1 for TIPO_PROCESADOR_R_MMG_S2;
...
create or replace synonym TIPO_PROCESADOR_R_4 for TIPO_PROCESADOR_R_MMG_S1@mamgbd_s1;

-- TIPO_TARJETA_VIDEO
create or replace synonym TIPO_TARJETA_VIDEO_R_1 for TIPO_TARJETA_VIDEO_R_MMG_S2;
...
create or replace synonym TIPO_TARJETA_VIDEO_R_4 for TIPO_TARJETA_VIDEO_R_MMG_S1@mamgbd_s1;
